-- Simple fix script for creating the feedback table
-- Run this directly in Supabase SQL Editor AFTER running fix_admin_column.sql

-- First, check if feedback table already exists
DO $$
BEGIN
