    ...
    <div className="relative overflow-hidden py-12 rounded-lg mb-8">
      ...
      <div className="relative px-6 text-center max-w-4xl mx-auto">
        ...
        <div className="mt-8 flex justify-center space-x-6">
          <a href="https://x.com/shfty_io" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-gray-700 transition-colors">
          ...
          <a href="https://discord.gg/shfty" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-gray-700 transition-colors">
          ...
          <a href="https://www.producthunt.com/products/shfty" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-gray-700 transition-colors">
            <svg className="h-6 w-6" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          ...
          <a href="https://github.com/shfty-io/shfty" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-gray-700 transition-colors">
